...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (1, 'JT', 'Jake', 'Thompson', 'jttest@email.com', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, 'HGIYeMTYpqfdwXpfSw2AUvxnvsC3');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (2, 'bbo9', 'Bob', 'Bo', 'bobbo@email.com', '2020-04-20', 'https://robohash.org/nisiautemet.png?size=150x150&set=set1', 2, 'vhbgqyeqelhgkohutnoglbdohssl');
