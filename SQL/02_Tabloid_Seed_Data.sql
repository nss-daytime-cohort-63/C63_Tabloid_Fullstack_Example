...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (1, 'Seabie', 'Seaborn', 'Mercer', 'surfermercer@email.com', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, '6qFf3yuQ9JQKD34LIhFs7szZz6R2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (2, 'Joemama', 'Joe', 'Mama', 'joemama808cruiser@email.com', '2020-04-20', 'https://robohash.org/nisiautemet.png?size=150x150&set=set1', 2, 'Owf10ffl49baEjakvjmh9VC4jPU2');
